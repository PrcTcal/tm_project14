...
public class WaitingView extends JPanel{
	...
	public WaitingView() {
		...
		chat_scroll = new JScrollPane(chatarea_ta, ScrollPaneConstants.VERTICAL_SCROLLBAR_ALWAYS, ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
		chat_scroll.setBounds(20, 510, 975, 155);
	...
	public JTextArea getChatarea_ta() {
		return chatarea_ta;
	}


	public JTextField getChatfield_tf() {
		return chatfield_tf;
	}
	...
	public void setCharacter_img(String character_num) {
		...
		chosen_character = new ImageIcon("C:\\\\Users\\\\hojja\\\\Desktop\\\\컴공\\\\2학년\\\\JAVA\\\\Workspace\\\\prj_Client_v_3\\\\bin\\\\images\\\\" + character_num);
		//character_l = new JLabel(character1_img);
		character_l.setIcon(chosen_character);
	}
