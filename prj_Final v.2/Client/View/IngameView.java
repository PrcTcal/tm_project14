...
//	private String pw;
	...
	private JLabel character_l, background_l, linethickness_l, menubar_l, user1ID_l, user2ID_l, user3ID_l, user4ID_l, user1ch_l, user2ch_l, user3ch_l, user4ch_l, timer_l, theme_l, round_l;	// 뒷배경용 라벨, 선굵기를 나타내는 라벨
...
//				chat_tx.setBounds(80,665,900,30);		
		        ...
		        user1ID_l.setBounds(150, 20, 55, 30);
		        ...
		        user2ID_l.setBounds(150, 20, 55, 30);
		        ...
		        user3ID_l = new JLabel("손진영");
		        user3ID_l.setBounds(150, 20, 55, 30);
		        ...
		        user4ID_l = new JLabel("손진영");
		        user4ID_l.setBounds(150, 20, 55, 30);
...
//        undecided.setBorder(BorderFactory.createCompoundBorder(lineBorder, emptyBorder));
	...
	public JLabel getTheme_l() {
		return theme_l;
	}


	public JLabel getLinethickness_l() {
		return linethickness_l;
	}


	public JPanel getPaint_p() {
		return paint_p;
	}
